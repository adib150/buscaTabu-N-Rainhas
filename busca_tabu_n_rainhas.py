# -*- coding: utf-8 -*-
"""Busca Tabu N-Rainhas

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17TK55PoYPVTZi1GbA258CjylALQkn9xG
"""
...
def buscatabu(posicoesrainhas,listatabu):
    ...
    for rainha in range(0,n):
        if rainha not in listatabu: #nao visita colunas visitadas anteriormente
            posicaoinicial=possivelestado[rainha] #guarda posicao inicial da rainha
            ...
            possivelestado[rainha]=posicaoinicial #volta a rainha pra posicao inicial ao mudar de rainha, pois so se mexe 1 rainha por jogada
...
if __name__ == "__main__": 
    ...
    print("Lista tabu Inicial:",listatabu)
    evaltabuleiroatual = eval(posicoesrainhas)
    print("Eval Atual:",evaltabuleiroatual)
    print ("Posicoes Iniciais:" , posicoesrainhas)
